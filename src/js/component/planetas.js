        ...
        <div className="scroll-container">
            <div className="d-inline-flex scroll">
                {store.planetas.map(planeta => (
                    <div className="card m-3" style={{ width: "18rem" }} key={planeta.url}>
                        ...
                        <div className="card-body">
                            ...
                            <div className="botonDetalle d-flex ">
                                <button className="btn btn-primary" onClick={() => navigate(`/planetaDetalles/${planeta.uid}`)}>Ver detalles</button>

                                <div className="corazon">
                                    <button className="botonCorazon" submit="button" onClick={() => { actions.setFavoritos(planeta.name) }}><div title="Like" className="heart-container">
